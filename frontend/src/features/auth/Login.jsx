          ...
          <div className="max-w-7xl mx-auto px-6 py-12">
               <div className="flex justify-center">
                    <div className="w-full md:w-2/3 lg:w-1/2">
                         <div className="flex items-center justify-center text-center text-white mb-6"
                         ...
                         <div className="bg-white rounded-xl shadow-sm p-6" style={{ borderRadius: 12 }}>
                              ...
                              <form onSubmit={handleSubmit} noValidate>
                                   <div className="mb-3">
                                        ...
                                        <div className="flex">
                                             ...
                                             type="text"
                                             name="username"
                                             className={`w-full px-3 py-2 border rounded-r-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.username ? "border-red-500" : "border-gray-300"}`}
                              ...
                              <p className="text-center text-gray-500 text-sm mb-0">
                                   Chưa có tài khoản?{" "}
                                   <Link to="/register" className="font-semibold text-blue-600 hover:text-blue-700">Đăng ký ngay</Link>
                              </p>
                         </div>
                         <p className="text-center mt-3 text-sm">
                         <Link to="/" className="text-blue-600 hover:text-blue-700">Quay về trang chủ</Link>
                         </p>
                    </div>
               </div>
          </div>
