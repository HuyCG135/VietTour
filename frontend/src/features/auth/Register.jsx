          ...
          <div className="max-w-7xl mx-auto px-6 py-12">
               ...
               <div className="w-full lg:w-7/12">
                    <div className="bg-white rounded-xl lg:rounded-l-none lg:rounded-r-xl shadow-sm p-6 h-full">
                         {message.text && (
                              <div className={`px-4 py-3 rounded-lg text-sm mb-4 ${message.type === "danger" ? "bg-red-50 text-red-700 border border-red-200" : "bg-green-50 text-green-700 border border-green-200"}`}>{message.text}</div>
                         )}
                         ...
                         <form onSubmit={handleSubmit} noValidate>
                              <div className="mb-3">
                                   ...
                                   <div className="flex">
                                        <span className="flex items-center px-3 py-2 border border-r-0 rounded-l-lg bg-gray-50 text-gray-500"><i className="fa-solid fa-user" /></span>
                                        <input
                                        id="fullname"
                                        name="fullname"
                                        type="text"
                                        className={`w-full px-3 py-2 border rounded-r-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.fullname ? "border-red-500" : "border-gray-300"}`}
                              ...
                              <div className="mb-3">
                                   ...
                                   <div className="flex">
                                        <span className="flex items-center px-3 py-2 border border-r-0 rounded-l-lg bg-gray-50 text-gray-500"><i className="fa-solid fa-phone" /></span>
                                        <input
                                        id="phone"
                                        name="phone"
                                        type="tel"
                                        className={`w-full px-3 py-2 border rounded-r-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.phone ? "border-red-500" : "border-gray-300"}`}
                              ...
                              <div className="mb-3">
                                   ...
                                   <div className="flex">
                                        ...
                                        className={`flex-1 px-3 py-2 border-t border-b text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.password ? "border-red-500" : "border-gray-300"}`}
                         ...
                         <p className="text-center text-gray-500 text-sm mb-0">
                              Đã có tài khoản?{" "}
                              <Link to="/login" className="font-semibold text-blue-600 hover:text-blue-700">Đăng nhập</Link>
                         </p>
                    </div>
               </div>
               </div>
               ...
               <div className="w-full">
                    <div className="w-full lg:w-7/12 lg:ml-[41.666667%]">
                         <p className="text-center mt-3 mb-0 text-sm"><Link to="/" className="text-blue-600 hover:text-blue-700">Quay về trang chủ</Link></p>
                    </div>
               </div>
          </div>
     );
